...
);isc.evalBoundary;isc.B.push(isc.A.validateFieldValue=function isc_DataSource_validateFieldValue(_1,_2){if(!isc.Validator)return _2;var _3=_1.validators;if(!_3)return _2;if(!isc.isAn.Array(_3)){this.$2j[0]=_3;_3=this.$2j}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+157;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
{return 0}}
if(_62.startsWith&&!_62.negate&&_54.length>_53.length&&_54.startsWith(_53))
{return 1}
if(_62.startsWith&&_62.negate&&_53.length>_54.length&&_53.startsWith(_54))
{return 1}
if(_62.endsWith&&!_62.negate&&_54.length>_53.length&&_54.endsWith(_53))
{return 1}
if(_62.endsWith&&_62.negate&&_53.length>_54.length&&_53.endsWith(_54))
{return 1}
if(!_62.startsWith&&!_62.endsWith&&!_62.negate&&_54.length>_53.length&&_54.contains(_53))
{return 1}
if(!_62.startsWith&&!_62.endsWith&&_62.negate&&_53.length>_54.length&&_53.contains(_54))
{return 1}
...
var _9=this.getValues();var _10=this.getDataSource();if(_10.sparseUpdates||_10.noNullUpdates){for(var _11 in _9){var _12=_9[_11];var _13=_2.oldValues[_11];if(_10.noNullUpdates&&_12===null){if(_7=="add"){delete _9[_11]}else{var _14=_10.getField(_11),_15;if(_14&&_14.nullReplacementValue!==_15){_9[_11]=_14.nullReplacementValue}else{var _16=SimpleType.getBaseType(_14.type,_10);if(_16=="integer"){_9[_11]=_10.nullIntegerValue}else if(_16=="float"){_9[_11]=_10.nullFloatValue}else if(_16=="date"||_16=="time"){_9[_11]=_10.nullDateValue}else if(_16=="boolean"){_9[_11]=_10.nullBooleanValue}else{_9[_11]=_10.nullStringValue}}}}else if(_10.sparseUpdates){var _14=_10.getField(_11);if(_14&&_14.primaryKey)continue;if(isc.isA.Date(_12)&&Date.compareDates(_12,_13)==0){delete _9[_11]}else if(_12==_13){delete _9[_11]}}}}

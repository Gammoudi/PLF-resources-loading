...
UIChatWindow.prototype.sendFile = function(fileChooserNode, event) {
  ...
  uploadForm.action = '/' + restContextName + '/fileexchange?username=' + userName + '&requestor=' + targetUser + '&description=' + description;
	...
	eXo.communication.chat.webui.UIChatWindow.insertCustomMsg("${chat.message.file.exchange.waiting.for.authorize}", activeTabControl.tabId);
	this.onload = null;
  };
  uploadForm.submit();
  //eXo.communication.chat.webui.UIChatWindow.insertCustomMsg('File exchange: Uploading file to server...', activeTabControl.tabId);
  eXo.communication.chat.webui.UIChatWindow.insertCustomMsg("${chat.message.file.exchange.uploading.file.to.server}", activeTabControl.tabId);

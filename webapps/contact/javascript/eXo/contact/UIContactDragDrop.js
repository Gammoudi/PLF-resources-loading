...
eXo.core.DragDrop.isIn = function(x, y, component) {
...
eXo.core.DragDrop.findDropableTarget = function(dndEvent, dropableTargets, mouseEvent) {
...
UIContactDragDrop.prototype.dndTrigger = function(e){
  e = e ? e : window.event;
	var menuItem = eXo.cs.EventManager.getEventTargetByClass(e,"MenuItem");
  if(menuItem) return ;

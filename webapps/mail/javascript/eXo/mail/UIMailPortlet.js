...
UIMailPortlet.prototype.msgPopupMenuCallback = function(evt){
    ...
    var src = eXo.cs.EventManager.getEventTargetByTagName(evt, "tr");
...
UIMailPortlet.prototype.defaultFolderPopupMenuCallback = function(evt){
    var UIContextMenuMail = eXo.webui.UIContextMenuMail;
    var src = eXo.cs.EventManager.getEventTargetByTagName(evt, "div");
...
UIMailPortlet.prototype.tagListPopupMenuCallback = function(evt){
    var UIContextMenuMail = eXo.webui.UIContextMenuMail;
    var src = eXo.cs.EventManager.getEventTargetByTagName(evt, "a");
...
UIMailPortlet.prototype.initNavigationAction = function(navId){
    ...
    while (i--) {
        eXo.cs.EventManager.addEvent(titleBars[i], "click", this.titleBarCallback);
    }
};

UIMailPortlet.prototype.titleBarCallback = function(evt){
    var DOMUtil = eXo.core.DOMUtil;
    var target = eXo.cs.EventManager.getEventTarget(evt);
...
UIMailPortlet.prototype.validateFieldsIncoming = function(id){
	...
	if(chkIsIncomingSSL != null ){
		...
		//eXo.cs.EventManager.addEvent(chkIsIncomingSSL, 'click', this.checkIncomingSSL);
...
eXo.webui.UIForm.tmpMethod = eXo.webui.UIForm.submitForm;
...
eXo.webui.UIForm.isEmail = function(email){
...
eXo.webui.UIForm.isEmpty = function(str){
